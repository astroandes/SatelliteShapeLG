...
We use this distribution to to estimate the  atipicallity
...
satellites usually included M31 studies.
...
\begin{table*}
  ...
  \caption{Results from simulations. Mean values and standard deviations for the different
    quantities describing the satellite distributions: plane width, $c/a$
    ratio and $b/a$ ratio. 
    The first column summarizes the results from the 24 pairs in
...
influence of different physical elements incluedes the simulation. 
