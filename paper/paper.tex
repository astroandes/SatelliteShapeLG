...
clearly differ. The corresponding plots for Illustris-1 and ELVIS can
be found in Figures \ref{fig:all_plots_illustris1} and
...
\caption{Same layout as Figure \ref{fig:physical}. 
  Each scalar
  quantity is recentered and normalized by the mean value and standard
  deviation from the $10^4$ randomizations. 
  The distribution from the randomization now has by definition a mean
