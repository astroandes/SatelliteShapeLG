...
Table \ref{table:M31} and Table \ref{table:MW} summarize the story we
have just told, including the results from this paper using the
...
distribution & $17$\\
\text{\cite{2013ApJ...766..120C}}& RMS height in M31's brightest
...
In this paper, we surmount the first difficulty by setting as a point of reference a
