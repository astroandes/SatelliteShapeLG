...
\begin{table*}
  ...
  \begin{tabular}{c|c|c|c|c|c|c|}
    \hline
        & M31 & M31 &M31 & MW & MW &MW\\
        & $w$ & $c/a$ & $b/a$ & $w$ & $c/a$ & $b/a$ \\     \hline
M31 $w$ & & & & & & \\ 
M31 $c/a$ & & & & & & \\ 
M31 $b/a$ & & & & & & \\ 
MW $w$ & & & & & & \\ 
...
MW $b/a$ & & & & & & \\ 
  ...
  \caption{Correlation matrix for the normalized values of $w$, $c/a$
    and $b/a$ computed from the $20$ pairs in the Illustris-1
    simulation (left) and the ELVIS project (right).}
\end{table*}
