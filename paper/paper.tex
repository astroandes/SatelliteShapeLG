...
We find as a common trends in thse simulations that: i) at most of
$1\%$ the pairs are expected  to have satellite distributions with the
same degree of deviation from sphericity as the Local Group; ii) between
$38\%$ to $59\%$ of the pairs have a halo with a satellite
distribution as aspherical as  in M31; and iii) at most $2\%$ have a
satellite distribution as planar as in the MW. 
These results place the LG close to the level of a 3-$\sigma$ outlier
in context provided by LCDM simulations.
\end{abstract}
