...
influence of the typical Dark Matter (DM) halo mass in the different pair samples.  
...
The brightest satellites in the M31 galaxy turn out to have a rather
typical distribution in the LCDM context, while the MW distribution is atypical in
this respect.  
...
detected \citep{2014MNRAS.441.2124B}. %XXXXXXX  
...
%homogeneous parent sample
%comentario: yo no describiría la poblacion como homogenea porque la
%mayoría están entre M31 y la MW la poblción está "loopsided"
...
current observational limitations. %citation?
...
Milky Way and its Large and Small Magellanic Clouds.%citation 
