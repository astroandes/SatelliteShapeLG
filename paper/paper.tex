...
\caption{Scalars in physical units describing satellite shape around the LG galaxies for
  ...
  lines show the 16, 50 and 84 percentiles of this distribution; the vertical solid line correspond to
  observations. 
  Outside the diagonal there are 2D histograms showing the $1$, $2$, $3$
  and $4\sigma$ contours for the randomized data.  
