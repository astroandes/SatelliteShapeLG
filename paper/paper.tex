...
of the distribution and their axis ratios.
...
In Section we describe the methods we use to build halo pairs and 
characterize its satellite distributions.
In Section we present our results to finally present our conclusions
in Section. 
