...
and, the criteria used to define the pairs and the methods used to
...
Although local correlations between LG assembly, pair kinematics, halo shapes and
...
understand what fearures in the initial conditions of our Local Group
are responsible for the assembly extreme features observed in its satellite
distribution. 
