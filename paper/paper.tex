...
total population of $27$ satellites \citep{2013ApJ...766..120C,
2013Natur.493...62I}, although considering the satellites ranked by
luminosity does not show any special feature.
Additionally \cite{2015ApJ...799L..13C} studied the observed
properties of several M31 satellites and concluded that there were no differences between
the on- and off-plane dwarf galaxies. This suggests that it is
unlikely that the on- and off-plane satellite galaxies have different
formation histories and that therefore the plane of satellites could
not be explained as being the result of a special formation
mechanism.
...
This Work & $c/a$ ratio, $b/a$ ratio and RMS width in 11-15 brightest
satellites & 20 halos from selected pairs in a cosmological N-body
...
threshold absolute observed value. 
...
The $b/a$ ratio is statistically the same between observations and the
...
observables, as it allows for an atypicality
