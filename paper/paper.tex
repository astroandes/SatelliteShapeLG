...
We demonstrate the method using the Illustris-1 and ELVIS simulations.
We find significant differences between the two simulations. 
In the case of Illustris-1 $0.05\%$ to $0.25\%$ of the pairs with isolation
...
sphericity.
In the ELVIS simulations this fractions drops dramatically to
$0.001\%$ of the pairs.
This makes the LG a $3\sigma$ outlier in LCDM simulations, with all
the weight lying on the extremly planar MW satellite distribution.
...
\includegraphics[width=0.47\textwidth]{expected_numbers_flip.pdf}
