...
\title[LG as an outlier]{We are not the 99 percent: the Local Group as an
  extreme outlier in ellipsoidal satellite distributions}
...
the extremly planar (width of $22\pm 2$kpc and mayor-to-minor axis
ration of $c/a=0.53\pm0.03$) satellite distribution in the MW. 
\end{abstract}
