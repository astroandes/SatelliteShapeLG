...
influence of the typical Dark Matter (DM) halo mass in the different
pair samples. 
...
LCDM paradigm. 
Understand this atipicallity will require quantifying the probability
...
between different numerical setups and choices to select LG pairs in
simulations.  
\end{abstract}
