...
structure of satellite galaxies around the MW, first suggested by
\cite{1976RGOB..182..241K} and \cite{1976MNRAS.174..695L}.  
...
The same year it was recognized, using numerical simulations, that the
satellites should not be compared with an spherically
symmetric distribution given that Dark Matter halos in LCDM
are expected to be triaxial
\citep{2005MNRAS.363..146L, 2005ApJ...629..219Z}.
Nevertheless, estimates of the chances to find simulated satellites as
planar as in the MW were inconclusive. 
\cite{2005MNRAS.363..146L} reported that
satellite planes should be expected in every DM while
\cite{2005ApJ...629..219Z} gave an estimate of a $2\%$ probability to
have an arrangement as extreme as in observations.

Later, \cite{2007MNRAS.374.1125M} used simulations to confirm the low chances
found in \cite{2005A&A...431..517K}.
This result was challenged by \cite{2009MNRAS.399..550L} who continue
to report a high chances to find a planar configuration;
the most recent numerical experiment with high resolution simulations
by \cite{2013MNRAS.429..725S} reports low chances to find the
observational result, but precise figures are not quoted in either of
these two reports. 
\citep{2015ApJ...815...19P, 2016MNRAS.457.1931S}.
The presence of a Vast Polar Structure of satellites around the Milky
Way,
stablished in the last decade
\citep{2013MNRAS.435.1928P}. 
...
2013Natur.493...62I}, although its brightest satellites
do not show any special feature and are consistent with a random
spherically symmetric distribution \citep{2006AJ....131.1405K,
  2007MNRAS.374.1125M, 2013ApJ...766..120C}.    
...
\cite{2015MNRAS.452.3838C} showed that part of the disagreement is the
ambiguitiy in defining a planar configuration, finding that actually
planar structures show a large diversity, hindering the possibility to
use one or to systems as a cosmological probe.


\begin{table*}
\centering
\begin{tabular}{|p{3.0cm}|p{6cm}| p{4.5cm}| c|}\hline
Reference & Target Measurement & Parent Sample & Probability ($\%$)\\\hline
\text{\cite{2006AJ....131.1405K}} & RMS height in M31's 15 brightest
satellites & Monte Carlo satellite distributions with a power law
radial distribution & $87-99$\\
\text{\cite{2007MNRAS.374.1125M}} & Triaxiality and RMS height in M31's
16 brightest satellites & Monte Carlo from an spherical power law radial
distribution & $17$\\
\text{\cite{2013ApJ...766..120C}}& RMS height in M31's 27 brightest
satellites & Monte Carlo randomized satellite distribution & High\\
This Work & Triaxiality and RMS height in M31's 11-15 brightest
satellites & 24 halos in cosmological N-body Dark Matter only simulation ($\sim
10^{6}$\Msun particle mass resolution)& 56 \\
This Work & Triaxiality and RMS height in M31's 11-15 brightest
satellites & 20 halos in cosmological N-body hydro simulation ($\sim
10^{6}$\Msun particle mass resolution)& 27 \\
This Work & Triaxiality and RMS height in M31's 11-15 brightest
satellites & 12 high resolution DM only N-body simulations ($\sim
10^{5}$\Msun particle mass resolution) of individual halos & 37 \\
\hline
\end{tabular}
\caption{Probability results derived in previous publications for the
  triaxiality and/or root mean squared (RMS) height of M31 satellites.
\label{table:M31}}
\end{table*}
...
\begin{tabular}{|p{3.0cm}|p{6cm}| p{4.5cm}| c|}\hline
Reference & Target Measurement & Parent Sample & Probability ($\%$)\\\hline
\text{\cite{2005A&A...431..517K}} & RMS height in MW's 11 classical
satellites & Monte Carlo from an spherical power law
radial distribution. & $<0.5$ \\
\text{\cite{2005MNRAS.363..146L}} & Triaxiality of MW's 11 classical
...
MW's 11 classical satellites & 3 high resolution DM only N-body
simulations. ($\sim10^6$ \Msun\ particle mass resolution) & 2 \\
\text{\cite{2007MNRAS.374.1125M}} & Triaxiality and RMS height in MW's
11-13 brightest satellites & Monte Carlo from a halo triaxiality distribution from LCDM
simulations & $<0.5$\\
\text{\cite{2009MNRAS.399..550L}}& Triaxiality in MW 11 classical satellites & 436 halos from a
cosmological N-body simulation ($1.3\times 10^{8}$\Msun\ particle mass)
&  High \\
\text{\cite{2013MNRAS.429..725S}}& $c/a$ ratio in MW's 12 brightest
satellites & 6 High resolution DM only N-body simulations ($\sim
10^3$\Msun particle mass resolution) of individual halos & Low \\
This Work & Triaxiality and RMS height in M31's 11-15 brightest
satellites & 24 halos in cosmological N-body Dark Matter only simulation ($\sim
10^{6}$\Msun particle mass resolution)& 3\\
This Work & Triaxiality and RMS height in M31's 11-15 brightest
satellites & 20 halos in cosmological N-body hydro simulation ($\sim
10^{6}$\Msun particle mass resolution)& 0.6 \\
This Work & Triaxiality and RMS height in M31's 11-15 brightest
satellites & 12 high resolution DM only N-body simulations ($\sim
10^{5}$\Msun particle mass resolution) of individual halos & 0.2 \\
\hline
\end{tabular}
