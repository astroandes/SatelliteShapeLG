...
the LG while having enough resolution to say something about the
satellites, this means that the high level parent sample has a small
size, making it hard to derive robust probabilities by counting.
