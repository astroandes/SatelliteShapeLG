...
this comparison was unfair given given that Dark Matter halos in LCDM
...
In this paper we control the first effect by setting as direct 
...
We characterize each satellite distribution in terms of the
