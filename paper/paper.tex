...
We use the same approach on simulations to build an explicit probability
distribution for this asphericity around galaxies similar to the MW and M31.   
...
We find as a common trend that at most of $0.2\%$ the pairs are
expected  to have satellite distributions with the same degree of
deviation from sphericity as the Local Group; between $19\%$ to $24\%$
of the pairs have a halo with a satellite distribution as aspherical
as in M31, while only $0.80\%$, at most, have a satellite distribution
as planar as in the MW. These results place the LG at the level of a
3-$\sigma$ outlier in context provided by LCDM simulations. 
\end{abstract}
