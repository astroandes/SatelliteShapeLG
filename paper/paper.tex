...
Its close enough that an observational 

This has prompted a discussion on whether the current dominant
paradigm for galaxy formation based on a Cold Dark Matter cosmology in
a expanding universe described by General Relativity with a
Cosmological Constant, so-called Lambda Cold Dark Matter (LCDM) model
can account for the existence of such a structure. 
...
the null hypothesis. 
Only the distribution for $\mu$ corresponds to a
