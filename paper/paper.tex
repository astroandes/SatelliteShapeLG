...
strong influence of the typical DM halo mass in the different pair samples.
However, there are three common trends in these simulations. 
First, at most of $2\%$ the pairs are expected to have satellite
distributions with the same asphericity as the Local Group; second,
...
select halo pairs in simulations, hopefully helping out to clarify the
reasons behind the LG atipicallity in LCDM. 
\end{abstract}
