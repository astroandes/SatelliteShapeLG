...
\title[LG as an outlier]{We are not the 99 percent: the Local Group as an
  outlier in galaxy pairs' satellite distributions}
...
around the Milky Way (MW) and M31, the dominant galaxies in the Local
Group (LG).
...
random uniform distribution, making the observations
consistent with theoretical expectations.
The special MW satellite distribution makes the LG an atypical pair in
the cosmological context provided by LCDM simulations. 
...
\section{Data from the ELVIS project}
\label{sim:ELVIS}

\section{Data from the Illustris project}
\label{sec:illustris}
...
the plane width and the $c/a$ axis ration.
Similar results from the ELVIS data are presented in Figure
