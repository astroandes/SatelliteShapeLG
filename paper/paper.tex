...
Using only the $11$ brightest satellites (as a comparison with the MW)
there does not seem to be any structure.
...
\begin{table*}
  ...
  \begin{tabular}{|p{2.5cm}|c|c|c|c|c|c|}
    \hline
    \multirow{2}{4.0cm}{} & \multicolumn{2}{c|}{\textbf{Illustris-1-DM}} & \multicolumn{2}{c|}{\textbf{Illustris-1}} & \multicolumn{2}{c|}{\textbf{ELVIS}}\\
    % \hline
    % \textbf{Inactive Modes} & \textbf{Description}\\
    \cline{2-7}
  ...
  \caption{Mean values and standard deviations for the different
    ...
    Illustris-1-DM, the second column from the 20 pairs in
