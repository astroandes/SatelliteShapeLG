...
#			plt.plot(All_AxisRatioH1All[i], All_AxisRatioH1random[i][j],'.', markersize=0.1,color="black")
#			plt.plot(All_AxisRatioH2All[i], All_AxisRatioH2random[i][j],'.', markersize=0.1,color="black")
	...
	#plt.plot(All_AxisRatioH1All,All_AxisRatioH1random_mean-All_AxisRatioH1random_mean_err,color="blue")
	#plt.plot(All_AxisRatioH1All,All_AxisRatioH1random_mean+All_AxisRatioH1random_mean_err,color="blue")
	...
	#plt.plot(All_AxisRatioH2All,All_AxisRatioH2random_mean-All_AxisRatioH2random_mean_er,color="red")
	#plt.plot(All_AxisRatioH2All,All_AxisRatioH2random_mean+All_AxisRatioH2random_mean_er,color="red")
...
def Inertiaplots_VS_random(All_AxisRatioH1, All_AxisRatioH1All ,All_AxisRatioH2, All_AxisRatioH2All, All_AxisRatioH1random, All_AxisRatioH2random, All_AxisRatioH1random_mean,  All_AxisRatioH1random_mean_err, All_AxisRatioH2random_mean, All_AxisRatioH2random_mean_err):
	...
	#for j in range (N):
	#	for i in range (Npairs):
	#		plt.plot(All_AxisRatioH1random_mean[i], All_AxisRatioH1random[i][j],'.', markersize=0.1,color="black")
	#		plt.plot(All_AxisRatioH2random_mean[i], All_AxisRatioH2random[i][j],'.', markersize=0.1,color="black")
	#plt.plot(All_AxisRatioH1random_mean, All_AxisRatioH1,'.', markersize=5,color="blue")
	#plt.plot(All_AxisRatioH2random_mean, All_AxisRatioH2,'.', markersize=5,color="red")
...
for i in range (Npairs):
	...
	if num_x_satH1>=4 and num_x_satH2>=4:
		...
		for j in range (N):
        	        ...
        	        #print "random1", i,j, index_randH2, num_x_H2, num_x_satH2
        	        #print "random2", i,j, index_randH1, num_x_H1, num_x_satH1
			...
			#print "Axisratio", i, j,  AxisRatioH1_r1, AxisRatioH1_r[j], AxisRatioH1_r
			#print "Axisratio", i, j,  AxisRatioH2_r2, AxisRatioH2_r[j], AxisRatioH2_r


#		plt.figure()
#		fig = plt.figure(figsize=(6, 6))
#		#ax = fig.add_subplot(1,1,1) # one row, one column, first plot
#		plt.hist(AxisRatioH1_r,  bins =25, color ="blue", alpha =0.7 )
#		plt.hist(AxisRatioH2_r,  bins =25, color ="red", alpha =0.7 )
#		#ax.hist((AxisRatioH1_r,AxisRatioH2_r),  bins =25, color =("red", "blue"))
#		plt.xlim([0,1])
#		#plt.xlabel('cos angle pos '+eigenvector, fontsize=15) 
#		#plt.ylabel('N Halos', fontsize=15)
#		plt.savefig('Hist_rand_dist'+GroupNum+'_'+str(N)+'.pdf')


		AxisRatioH1_r_mean = scipy.stats.tmean(AxisRatioH1_r, limits=None, inclusive=(True, True))
		#AxisRatioH1_r_mean_err =scipy.stats.tsem(AxisRatioH1_r, limits=None, inclusive=(True, True))	
		...
		#AxisRatioH2_r_mean_err =scipy.stats.tsem(AxisRatioH2_r, limits=None, inclusive=(True, True))	
		AxisRatioH2_r_mean_err = np.var(AxisRatioH2_r, axis=None, dtype=None, out=None, ddof=0)	
		
		#print AxisRatioH1_r_mean, AxisRatioH1_r_mean_err, i
		...
		#print ratioAxisRatioH1
		#print ratioAxisRatioH2
...
#print "All_AxisRatioH1random[1]", All_AxisRatioH2random[5][1], All_AxisRatioH2random[5]
...
#for i in range (Npairs):
#for i in range (1):
	#SatRatio_H1[i] = 20*All_SatNumH1[i]/All_SubHaloNumH1[i]
	#SatRatio_H2[i] = 20*All_SatNumH2[i]/All_SubHaloNumH2[i]
	#ratioAxisRatioH1[i]= All_AxisRatioH1[i]/All_AxisRatioH1random_mean[i]
	#ratioAxisRatioH2[i]= All_AxisRatioH2[i]/All_AxisRatioH2random_mean[i]

#plt.figure()
#plt.hist(ratioAxisRatioH1, bins=15, histtype='bar', rwidth=0.8)
#plt.hist(ratioAxisRatioH2, bins=15, histtype='bar', rwidth=0.8)
#plt.savefig('AxisRatioHISTOGRAM.pdf')
