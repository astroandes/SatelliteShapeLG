...
def MW_data():
	x_MW_sats = [17.1, -0.6, 16.5, -4.3, -22.2, -5.2, -36.7, -25.0, -41.3, -77.3, -123.6]
	y_MW_sats = [2.5, -41.8, -38.5, 62.2, 52.0, -9.8, -56.9, -95.9, -51.10, -58.3, -119.3]
	z_MW_sats = [-6.4, -27.5, -44.7, -43.2, 53.5, -85.3, 57.8, -39.8, -134.91, 215.2, 191.7]
